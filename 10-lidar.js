...
window.setLiDARSupport = function(supported) {
    console.log("Stato supporto LiDAR ricevuto da Swift:", supported);
...
function measureWithLiDAR(buttonElement) {
    if (!window.isLiDARAvailable) {
        console.warn("Il sensore LiDAR non è disponibile su questo dispositivo.");
        return;
    }
...
window.onLiDARMeasurementComplete = function(distanceString) {
    console.log("Distanza ricevuta da ARKit:", distanceString);
